...
WhitneyGroup:
	...
	db 20, DUNSPARCE, NO_ITEM,  GLARE, HEADBUTT, ROCK_SLIDE, BITE
	db 20, FURRET, NO_ITEM,    HEADBUTT, SURF, ICE_PUNCH, DIG
	db 22, MILTANK, MIRACLEBERRY,    ROLLOUT, ATTRACT, HEADBUTT, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 16, SPINARAK, NO_ITEM,    PSYBEAM, PURSUIT, DIG, SONICBOOM
...
Rival1Group:
	...
	db 17, TYROGUE, NO_ITEM, MACH_PUNCH, HI_JUMP_KICK, THIEF, STRENGTH
	...
	; RIVAL1 (7)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 22, HITMONTOP, NO_ITEM,   MACH_PUNCH, ROLLING_KICK, THIEF, MUD_SLAP
...
YoungsterGroup:
	...
	db  5, CLEFFA, NO_ITEM, HEADBUTT, ICY_WIND, SHADOW_BALL, MUD_SLAP
	db  5, IGGLYBUFF, NO_ITEM, SING, FAINT_ATTACK, HEADBUTT, DREAM_EATER
	db  6, SMEARGLE, NO_ITEM, SWIFT, EMBER, VINE_WHIP, WATER_GUN
	db -1 ; end
...
SchoolboyGroup:
	...
	db 19, CORSOLA, NO_ITEM, SURF, PSYCHIC_M, ROCK_SLIDE, ICE_BEAM
	...
	db 21, LANTURN, NO_ITEM, WATERFALL, SPARK, NO_MOVE, NO_MOVE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 16, PINECO, NO_ITEM, SELFDESTRUCT, PIN_MISSILE, STRENGTH, GIGA_DRAIN
	db 16, PHANPY, NO_ITEM, MUD_SLAP, ANCIENTPOWER, HEADBUTT, WATER_GUN
...
GruntMGroup:
	...
	db 14, MARILL, NO_ITEM, BUBBLEBEAM, ICY_WIND, LIGHT_SCREEN, HEADBUTT
	db 14, SANDSHREW, NO_ITEM, DIG, THIEF, METAL_CLAW, HEADBUTT
	db 16, BEEDRILL, MIRACLEBERRY, TWINEEDLE, POISON_STING, SWIFT, MEGA_DRAIN
	db -1 ; end
...
BugCatcherGroup:
	...
	db  6, WEEDLE, NO_ITEM, POISON_STING, STRING_SHOT, NO_MOVE, NO_MOVE
	db  6, CATERPIE, NO_ITEM, TACKLE, STRING_SHOT, NO_MOVE, NO_MOVE
	db  6, PARAS, NO_ITEM, FURY_CUTTER, DIG, MEGA_DRAIN, PURSUIT
	db  7, VENONAT, NO_ITEM, MEGA_DRAIN, PSYWAVE, THIEF, SWIFT
	db -1 ; end
	...
	db 20, SHUCKLE, NO_ITEM, TOXIC, WRAP, DOUBLE_TEAM, PROTECT
	db 20, PINECO, NO_ITEM, GIGA_DRAIN, STRENGTH, PIN_MISSILE, REFLECT
	db 22, LEDIAN, NO_ITEM, THUNDERPUNCH, ICE_PUNCH, LIGHT_SCREEN, PSYBEAM
	db -1 ; end
...
HikerGroup:
	...
	db 12, WOOPER, NO_ITEM, WATER_GUN, SLAM, DIG, ANCIENTPOWER
	db 12, SWINUB, NO_ITEM, MUD_SLAP, POWDER_SNOW, BITE, ANCIENTPOWER
	db 14, PUPITAR, NO_ITEM, STOMP, BITE, DIG, ANCIENTPOWER
	db -1 ; end
...
PicnickerGroup:
	...
	db  14, GASTLY, NO_ITEM, SHADOW_BALL, MEGA_DRAIN, PSYWAVE, NO_MOVE
	...
	db 16, SKIPLOOM, NO_ITEM, SLEEP_POWDER, GIGA_DRAIN, HEADBUTT, CONFUSION
